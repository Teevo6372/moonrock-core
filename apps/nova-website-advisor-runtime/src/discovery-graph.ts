...
const sharedQuestions: DiscoveryQuestion[] = [
  ...
  {
    id: "team-size", path: "shared", field: "teamSize",
    prompt: "How many people are on your team right now, including you?",
    prompts: [
      "How many people are on your team right now, including you?",
      "Is it just you running things, or do you have staff?",
      "Roughly how many people are in the business at the moment?",
      "Are you operating solo, or do you have a team behind you?",
    ],
    answerType: "text", required: false,
    askWhen: (answers) => answers.businessChallenges !== undefined,
  },
  {
    id: "has-website", path: "shared", field: "hasExistingWebsite",
    prompt: "Do you already have a website for the business?",
    answerType: "boolean", required: false,
    askWhen: (answers) => answers.businessChallenges !== undefined,
  },
  {
    id: "website-url", path: "shared", field: "existingWebsiteUrl",
    prompt: "What's the URL? I'll take a look and factor in what you've already got.",
    prompts: [
      "What's the URL? I'll take a look and factor in what you've already got.",
      "Drop the URL here — I'll pull up what I can and include it in your Flight Plan.",
      "What's the website address? I can review it and get a better picture of your setup.",
    ],
    helpText: "Any URL is fine — I'll use it to get a better sense of your brand and current setup.",
    answerType: "text", required: false,
    askWhen: (answers) => answers.hasExistingWebsite === true,
  },
